...
function initSideBar() {
  ...
  for (var i in exampleConfig) e.append(createSideBarMenuItem(i, exampleConfig[i], !1))
}
...
function sidebarScrollFix() {
  $("ul#sidebar-menu>li").hover(function (e) {
    ...
    $("body").hasClass("sidebar-collapse") && ($(this).children("ul").removeClass("scroll-list"), $(this).children("ul").css({
      height: "auto"
    }))
...
function createSideBarMenuItem(e, i, a) {
  if (i) {
    ...
    return i.content ? (createSideBarMenuTitle(e, i.name, !0).appendTo(n), createSideBarSecondMenu(i.content, e).appendTo(n)) : createSideBarMenuTitle(e, i.name, !1).appendTo(n), n
  }
}
...
function createSideBarSecondMenu(e, i) {
  ...
  for (var n in e) {
    ...
    t.appendTo(a);
    var r = e[n];
    containExample && r.content ? (createSideBarMenuSecondTitle(i + "-" + n, r.name, !0).appendTo(t), createSideBarThirdMenu(r.content).appendTo(t)) : createSideBarMenuSecondTitle(i + "-" + n, r.name, !1).appendTo(t)
  }
  return a
}
...
function createSideBarThirdMenu(e) {
  for (var i = $("<ul class='treeview-menu third-menu'></ul>"), a = e && e.length ? e.length : 0, n = 0; n < a; n++) {
    ...
    s.appendTo(i), "" != r && t.name && createSideBarMenuThirdTitle(r, t.name, !1).appendTo(s)
  }
  return i
}
...
function createSideBarMenuTitle(e, i, a) {
  ...
  var r = "";
  r = -1 != location.href.indexOf("editor.html") ? "../examples.html#" + e : "#" + e;
  var s = $("<a  href='" + r + "' >" + n + "<span class='firstMenuTitle'>" + i + "</span></a>");
  return a && s.append(createCollapsedIcon()), s
}
...
function createSideBarMenuThirdTitle(e, i, a) {
  ...
  return a && r.append(createCollapsedIcon()), r
}
...
function selectMenu(e, i) {
  ...
  1 !== i && (_selectTarget(a.parent().parent().parent().parent()), _selectTarget(a.parent().parent()), _selectTarget(a.parent()), _selectTarget(a.find("ul")))
}

function _getTarget(e, i) {
  var a;
  return i ? (1 === i && ($("section#sidebar li.active").removeClass("active"), (a = $("section#sidebar li#iclient_" + e)).children("ul").show()), 2 === i && ($("section#sidebar li.active ul.active li").removeClass("active"), a = $("section#sidebar li.treeview").children("ul").children("li#" + e))) : ($("section#sidebar #ul").addClass("active"), $("section#sidebar li.active").removeClass("active"), a = $("section#sidebar li#" + e)), a && a.addClass("active"), a
}

function _selectTarget(e) {
  if (e && !(e.length < 1)) {
    var i = e.attr("class");
    i && -1 < i.indexOf("treeview-menu") && -1 === i.indexOf("menu-open") && (e.addClass("menu-open"), e.css("display", "block")), i && -1 < i.indexOf("treeview") && e.addClass("active")
  }
}